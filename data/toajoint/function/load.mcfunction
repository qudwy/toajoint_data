...
# summon minecraft:armor_stand 0.0 70.0 2.5 {Rotation:[-180.0f,0.0f],Tags:["hdfire"],Invisible:1b,equipment:{head:{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;111,222,333,441],properties:[{name:"textures",value:""}]}}}}}
# summon minecraft:armor_stand 0.0 70.0 -2.5 {Rotation:[0.0f,0.0f],Tags:["hdwater"],Invisible:1b,equipment:{head:{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;111,222,333,442],properties:[{name:"textures",value:""}]}}}}}
# summon minecraft:armor_stand -2.5 70.0 1.0 {Rotation:[-112.5f,0.0f],Tags:["hdair"],Invisible:1b,equipment:{head:{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;111,222,333,443],properties:[{name:"textures",value:""}]}}}}}
# summon minecraft:armor_stand 2.5 70.0 1.0 {Rotation:[112.5f,0.0f],Tags:["hdstone"],Invisible:1b,equipment:{head:{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;111,222,333,444],properties:[{name:"textures",value:""}]}}}}}
# summon minecraft:armor_stand 2.5 70.0 -1.0 {Rotation:[67.5f,0.0f],Tags:["hdearth"],Invisible:1b,equipment:{head:{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;111,222,333,445],properties:[{name:"textures",value:""}]}}}}}
# summon minecraft:armor_stand -2.5 70.0 -1.0 {Rotation:[-67.5f,0.0f],Tags:["hdice"],Invisible:1b,equipment:{head:{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;111,222,333,446],properties:[{name:"textures",value:""}]}}}}}
# summon minecraft:interaction 0.0 71.35 2.5 {Rotation:[-180.0f,0.0f],width:0.8f,height:0.8f,Tags:["iafire"],CustomNameVisible:1b,CustomName:{"text":"мир Огня","color":"red"}}
# summon minecraft:interaction 0.0 71.35 -2.5 {Rotation:[0.0f,0.0f],width:0.8f,height:0.8f,Tags:["iawater"],CustomNameVisible:1b,CustomName:{"text":"мир Воды","color":"blue"}}
# summon minecraft:interaction -2.5 71.35 1.0 {Rotation:[-112.5f,0.0f],width:0.8f,height:0.8f,Tags:["iaair"],CustomNameVisible:1b,CustomName:{"text":"мир Воздуха","color":"green"}}
# summon minecraft:interaction 2.5 71.35 1.0 {Rotation:[112.5f,0.0f],width:0.8f,height:0.8f,Tags:["iastone"],CustomNameVisible:1b,CustomName:{"text":"мир Камня","color":"yellow"}}
# summon minecraft:interaction 2.5 71.35 -1.0 {Rotation:[67.5f,0.0f],width:0.8f,height:0.8f,Tags:["iaearth"],CustomNameVisible:1b,CustomName:{"text":"мир Земли","color":"light_purple"}}
# summon minecraft:interaction -2.5 71.35 -1.0 {Rotation:[-67.5f,0.0f],width:0.8f,height:0.8f,Tags:["iaice"],CustomNameVisible:1b,CustomName:{"text":"мир Льда","color":"white"}}

# --- general gamerules --- #
execute in overworld run gamerule allow_entering_nether_using_portals false
...
execute in overworld run gamerule random_tick_speed 0
...
execute in overworld run gamerule max_minecart_speed 64
...
execute in overworld run gamerule respawn_radius 0
...
execute in overworld run gamerule advance_time true
...
execute in overworld run gamerule advance_weather false
...
execute in overworld run gamerule reduced_debug_info true
...
execute in overworld run gamerule spread_vines false
...
execute in overworld run gamerule show_death_messages false
...
execute in overworld run gamerule mob_griefing true
...
execute in overworld run gamerule send_command_feedback false
...
execute in overworld run gamerule max_snow_accumulation_height 1
...
# --- spawner gamerules --- #
execute in overworld run gamerule spawn_mobs false
execute in overworld run gamerule spawn_monsters false
execute in overworld run gamerule spawn_patrols false
execute in overworld run gamerule spawn_phantoms false
execute in overworld run gamerule spawn_wandering_traders false
execute in overworld run gamerule spawn_wardens false
